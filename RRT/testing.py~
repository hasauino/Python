...
def node():
	...
	global mapData
    	...
    	rospy.Subscriber("/robot1/map", OccupancyGrid, mapCallBack)
	...
	listener.waitForTransform('/robot1/map', '/robot1/base_link', rospy.Time(0),rospy.Duration(10.0))
...
#Set the frame ID and timestamp.  See the TF tutorials for information on these.
    	points.header.frame_id=line.header.frame_id="/robot1/map"
...
# Assigner	
		(trans1,rot) = listener.lookupTransform('/robot1/map', '/robot1/base_link', rospy.Time(0))  
		(trans2,rot) = listener.lookupTransform('/robot1/map', '/robot2/base_link', rospy.Time(0))  		
    		x=LA.norm(array([ trans1[0],trans1[1] ])-x_new)<LA.norm(array([ trans2[0],trans2[1] ])-x_new)
    		
    		if (x and r1) or (x and not r2) or (r1 and not r2):
    			client1.wait_for_result()
    			client1.get_result()
    			r1=1
    			client1.send_goal(goal)
